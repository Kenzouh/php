...
<body style="text-align: center; padding: 0px; margin: 0px;">
    ...
    <h1 style="font-size: 80px; padding: 20px;">This is the About Page! :D</h1><br/>
    
    <h2 style="font-size: 60px; padding: 20px;">This is the page that talks about us!</h2><br/><br/><br/>
</body>
</html>
